      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="px-6 py-5">
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              className="flex-shrink-0 flex items-center gap-1.5 text-xs text-gray-500 border border-gray-200 px-3 py-2 rounded-lg hover:border-brand-300 hover:text-brand-600 transition-colors"
              title="次フェーズで保存機能を実装"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          >
            {editNotes ? (
              <>
                ...
                />
                <p className="text-[10px] text-amber-500 mt-1">※ 次フェーズで保存機能を実装</p>
              </>
            ) : (
